...
<div className="p-2 loginFormLoginButton mt-3 w-100" style={{cursor: 'pointer'}}>    <Link href='/' passHref>
    <div className='addFundsButtonText text-center'>
        Make An Investment
    </div>
    </Link>
...
<div className="p-2 mt-3 loginBackButton w-100" style={{cursor: 'pointer'}}>
    <Link href='/transactions-reports' passHref>
